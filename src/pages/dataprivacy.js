...
const DataPrivacy = () =>
  <Layout title="Datenschutzerklärung">
    ...
    <small>As the author of this website is a german citizen, thus this site itself is subject to german law, the following data privacy policy is presented in german.</small>
    ...
    <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a className="external-link" href="https://developers.google.com/fonts/faq" rel="noopener noreferrer">https://developers.google.com/fonts/faq</a> und in der Datenschutzerklärung von Google: <a className="external-link" href="https://policies.google.com/privacy?hl=de" rel="noopener noreferrer">https://policies.google.com/privacy?hl=de</a>.</p>
